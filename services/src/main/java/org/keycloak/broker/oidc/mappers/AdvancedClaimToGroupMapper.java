...
public class AdvancedClaimToGroupMapper extends AbstractClaimToGroupMapper {
    ...
    static {
        ...
        roleProperty.setName(ConfigConstants.GROUP);
        roleProperty.setLabel("Group");
        roleProperty.setHelpText("Group to assign the user to if claim is present.");
        roleProperty.setType(ProviderConfigProperty.GROUP_TYPE);
